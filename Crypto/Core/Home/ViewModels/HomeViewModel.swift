...
//  Crypto
//
//  Created by volkancelik on 14.04.2023.
//
...
//            .store(in: &cancellables)
        ...
        $searchText
            ...
            .debounce(for: .seconds(0.5), scheduler: DispatchQueue.main)//will wait 0.5 before running the rest of the code
    ...
    func reloadata(){
        ...
        HapticManager.notificiation(type: .success)
    }
    ...
    private func sortCoins(sort:SortOption,coins: inout [CoinModel]){
        ...
        case .rank,.holdings:
            ...
            //retun coins.sorted { coin1, coin2-<Bool in
